# -*- coding: utf-8 -*-
"""
Created on Tue Dec 14 14:33:02 2021
...
class VPNSFnet:
    ...
    def __init__(self, x0, y0, z0, t0, u0, v0, w0, xb, yb, zb, tb, ub, vb, wb, x, y, z, t, layers, ExistModel=0, nnDir=''):
    ...
    def getloss(self):
        ...
        return loss, loss_lb, loss_li, loss_le