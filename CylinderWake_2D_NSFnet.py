# -*- coding: utf-8 -*-
"""
Created on Wed Nov 17 21:28:41 2021

@author: Arthur
"""

# cylinder wake(2 dimension with time)
import sys
...
# Custom newfig and savefig functions
...
if __name__ == "__main__":
    ...
    # supervised
    N_train = 140000 # spatio-temporal scattered points inside the domain to compute the residuals.

    layers = [3, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 3] # The NSFnets contain 10 hidden layers and 100 neurons per layer
    ...
    # We consider a domain defined by [1, 8] × [−2, 2] and the time interval is [0, 7]
    data1 = np.concatenate([x, y, t, u, v, p], 1)
    
    # time interval is [0, 7]
